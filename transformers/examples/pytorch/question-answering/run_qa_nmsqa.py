...
def main():
    ...
    byte_tokenizer = AutoTokenizer.from_pretrained(
        "bert-base-uncased",
        cache_dir=model_args.cache_dir,
        use_fast=True,
        revision=model_args.model_revision,
    ...
    def prepare_train_features(examples):
        ...
        for qlen,clen, ans_start, ans_end in zip(qlens,clens, examples[answer_start_column_name], examples[answer_end_column_name]):
            ...
            while True:
                ...
                if ans_start > start and ans_end < end:
                    tokenized_examples["start_positions"].append(1 + qlen + 1 + 1 + ans_start)
        ...
        #print(len(tokenized_examples["start_positions"]))
        #for gold, my in zip(tokenized_examples["overflow_to_sample_mapping"], which_question):
        #    if gold != my:
        #        print(my)
        #        print(list(tokenized_examples["overflow_to_sample_mapping"]).count(82))
        #        print(which_question.count(82))
        #        print()
        #        print(qlens[82])
        #        print(clens[82])
        #        s()
